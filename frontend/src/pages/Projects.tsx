...
const projects = [
  {
    ...
    description: 'My own site - AWS hosting 🔋 included',
    url: 'https://github.com/placy2/personal-website',
  },
  {
    name: 'Big Data/ML Course Final Project',
    description: 'Analysis of large opioid distribution dataset',
    url: 'https://github.com/placy2/US-opioid-data-analysis',
  },
  {
    name: 'Reddit/Telegram Bot',
    description: 'Fun little Telegram bot that scrapes Reddit',
